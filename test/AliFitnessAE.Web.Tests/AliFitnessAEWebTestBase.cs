...
{
    public abstract class AliFitnessAEWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AliFitnessAEWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AliFitnessAEWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AliFitnessAEDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AliFitnessAEDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AliFitnessAEDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AliFitnessAEDbContext, Task<T>> func)
        {
            T result;
