namespace AliFitnessAE.Authorization
{
    public static class PermissionNames
    {
        ...
        public const string Pages_UserType = "Pages.UserType";
        public const string Pages_Roles = "Pages.Roles";
        public const string Pages_Topic = "Pages.Topic";
        ...
        public const string Pages_Topic_DeleteTopic = "Pages.Topic.DeleteTopic";

        public const string Pages_UserTracking_GetAll = "Pages.UserTracking.GetAll"; 
    }
}
